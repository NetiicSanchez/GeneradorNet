...
app.get('/clientes-disponibles', protegido, async (req, res) => {
  const todos = [
    ...
    "EDGAR ALFREDO DE LEON SALAZAR",
    "RUMALDA ROSARIO AGUSTIN",
    "NILSON JAVIER FUENTES MURGA B",
    "ADOLFO NOE BRAVO RAMIREZ",
    "ROSANGELICA GUADALUPE CLEMENTE RAMIREZ DE GOMEZ",
    "ADELAIDA MARISOL SANCHEZ HERRERA",
    "EVELYN JEANETH LOPEZ ENRIQUEZ DE MACH",
    "YANETH AZUCENA LUCAS CASTANON",
    "FERNANDO VALLS ROBLES",
    "ESTEBAN FRANCISCO CASTILLO CASTILLO",
    "	EVELYN YOJANA GARCIA VALIENTE DE PEREZ",
    "ADAN ALDAIR MANCOLAS PEREZ",
    "MIGDALY ODETH GUTIERREZ ESTEBAN",
