...
app.get('/clientes-disponibles', protegido, async (req, res) => {
 ...
 "JUAN CHAY CHAY",
 "EVELIN IDALIA RUANO LOPEZ DE PEREZ",
 "DEYMI YANETH SANTOS CHACON",
 "	MIRZA GABRIELA QUIÑONEZ GOMEZ DE DE LOS SANTO",
 "BRENDA LETICIA VICENTE BOL",
 "WUILSON REGINO SOLIS VENTURA",
 "JOSE VITALINO PEREZ JUAREZ",
 "MARVIN HUMBERTO MORALES PEREZ B",
 "SANTOS EFRAIN ROBLERO MORALES",
 "CONSUELO TIGUILA REYES DE SONTAY B",
 "ROBERTO YAH PELICO",
 "MILTON ELIAN ROSALES SARAT",
