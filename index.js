...
app.get('/clientes-disponibles', protegido, async (req, res) => {
 ...
 "	ELSA NAYELI SALAZAR RODAS",
 "MANUEL DE JESUS ESTEBAN ORODOÑEZ",
 "CESAR FERNANDO ALVARADO HERNANDEZ",
 "YEYMY LETICIA HERNANDEZ PASTOR",
 "JAQUELINE SUSAN SALES GARCIA DE VELASQUEZ B",
 "MARIA POZ CHAY",
 "VILMA DANIELA VASQUEZ RIVAS",
 "CARLOS ALBERTO CARRETO RAMIREZ",
 "	EVELYN CAROLINA CHAVEZ CAMACHO",
 "BRAYAN ABELARDO EQUILA DIAGUT",
