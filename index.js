...
app.get('/clientes-disponibles', protegido, async (req, res) => {
  const todos = [
    "TAMARIS ANABEL GARCIA VENTURA",
    "DORA ELIZABETH CRUZ GARCIA",
    "JOSEFINA CHAPERNO MEJIA B",
    "	MARIVELA ARACELY XILOJ IXCOY",
    "JOEL ADOLFO HERNANDEZ MENDEZ",
    "RONY RAFAEL MORENO GRAJEDA",
    "CINTHYA SELENA MARTINEZ CHOCHOM",
    "LILIAN ROXANA AGUILAR BATRES",
    "VICTOR JOSUE CIFUENTES AILON",
    "FRANCISCO CIRILIO TISTOJ SEBASTIAN",
    "ANGELICA ENCARNACION GALINDO CARDONA",
    "	KENLI MARISOL PEREZ RENOJ DE CHUN",
    "ANAI MORALES OROZCO",
    "LOYDA MARIELA SUM GARCIA",
    "	HENRY AILON MOLINA B",
    "NORMA DE JESUS MEJIA Y MEJIA",
    "BRENDY ESTEFANI ORTIZ TAMU",
    "	MARLON JONATAN ROSALES MEJIA",
    "	EDWIN OTONIEL BARRIOS MORENO",
    "	GERARDO ANTONIO SALAZAR BARRIOS"
