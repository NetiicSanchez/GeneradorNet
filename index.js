...
app.get('/clientes-disponibles', protegido, async (req, res) => {
 ...
 "BANI BIGVAI HERRERA MACARIO",
 "SAMUEL DAVID COLORADO MENDEZ",
 "GEYDY DINORA SANTANA ESCOBAR",
 "CELSO DE JESUS HERNANDEZ QUICHE",
 "ANAHI ALBERTINA AJANEL GUIX",
 "ABNER GERARDO PEREZ VASQUEZ",
 "REYNA JUDITH VALIENTE CORADO",
 "DARWIN FELIPE SANTIAGO NAVARRO",
 "MERLYN STEFANY CAROLINA ALONZO MORALES",
 "EDUARDO ZINADIN PEREZ BARRIOS"
