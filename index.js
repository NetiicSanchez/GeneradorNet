...
app.get('/clientes-disponibles', protegido, async (req, res) => {
  const todos = [
    ...
    "MARCO TULIO JUAREZ MENDEZ",
    "JOSE EDUARDO PLEITEZ DIAZ",
    "GERARDO ULISES MALDONADO FUENTES",
    "LEIDY AYARI XITAMUL GARCIA",
    "MARIO ABEL RAMOS SOC",
    "MARIO DAVID POZ ALVARADO",
    "MARLON ESTUARDO MACHIC CHOJOLAN",
